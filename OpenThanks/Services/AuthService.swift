...
final class AuthService {
    ...
    private static func friendlyAuthError(_ error: Error) -> String {
        ...
        if lower.contains("unacceptable audience")
            ...
            return "Apple sign-in isn’t configured for this app yet. In Supabase → Authentication → Providers → Apple, add Client ID “com.openthanks.gratitude” (keep your web Services ID first)."
        }
        return raw
    }
