...
/// `v0-gratitude-network/lib/friday-prompts.ts` (same week-index formula + emoji).
enum FridayPrompts {
    struct Prompt: Equatable {
        ...
        /// Leading emoji for lock-screen / in-app system notification avatar.
        let emoji: String
    }

    private static let questions: [(emoji: String, headline: String, starter: String)] = [
        (
            "🌤️",
