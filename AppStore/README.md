...
| `Screenshots/iPhone-6.9-inch/` | **Primary** iPhone screenshots (1320×2868) — upload these for 1.1 |
| `Screenshots/iPhone-6.7-inch/` | Optional (1290×2796) |
| `Screenshots/iPhone-6.5-inch/` | Optional (1284×2778) |
| `Screenshots/iPad-13-inch/` | Later universal update only (2064×2752) — **do not upload for 1.1** |
...
4. Upload **iPhone** screenshots only from `Screenshots/iPhone-6.9-inch/` (1.1 is iPhone-only; remove any existing iPad media in Connect)
5. In Xcode: select **Any iOS Device** → **Product → Archive** → **Distribute App** (build **1.1 (6)**)
6. Complete App Privacy questionnaire using the labels in `METADATA.md`
7. Paste review notes from `REVIEW_NOTES.md`; reply in Resolution Center (SIWA + iPhone-only); do not delete `test@test.com` during review
